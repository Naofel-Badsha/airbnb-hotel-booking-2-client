        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1 text-sm">
              ...
              <textarea
                id="description"
                className="block rounded-md bg-white focus:rose-300 w-full h-32 px-4 py-3 text-gray-800  border border-rose-300 focus:outline-rose-500 "
                name="description"
              ></textarea>
            </div>
          </div>
